...
public class PruebaInterfazPorPagar {
    public static void main(String[] args){
        ...
        objetosPorPagar[0] = new Factura("01234", "asiento",
        2, 375.00);
        objetosPorPagar[1] = new Factura("56789", "llanta",
        4, 79.95);
        objetosPorPagar[2] = new EmpleadoAsalariado2("John", "Smith", 
        "111-11-1111", 800.00);
        objetosPorPagar[3] = new EmpleadoAsalariado2("Lisa", "Barnes", 
        "888-88-8888", 1200.00);
