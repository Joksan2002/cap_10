public class EmpleadoBaseMasComision extends EmpleadoPorComision {
    private double salarioBase; // salario base por semana
     ...
     String numeroSeguroSocial, Fecha fechaNacimiento, double ventasBrutas,double tarifaComision, double salarioBase){
    ...
    public String toString(){
        ...
        "con salario base", super.toString(), "salario base", obtenerSalarioBase());
    }
}
